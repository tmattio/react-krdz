...
export const receiveEditCard = (id, name, listId) => ({
...
export const moveCard = (draggedId, targetId) => ({
  type: ActionTypes.MOVE_CARD,
  draggedId,
  targetId,
});

export const changeCardList = (cardId, listId) => ({
  type: ActionTypes.CHANGE_CARD_LIST,
  cardId,
  listId,
});

export const receiveChangeCardList = (cardId, listId) => ({
  type: ActionTypes.CHANGE_CARD_LIST,
  cardId,
  listId,
});

export const receiveAddList = (name, id) => ({
...
export const getAllLists = boardId => (dispatch) => {
  trello.getBoardLists(boardId, lists =>
    lists.forEach(list =>
      dispatch(receiveAddList(list.name, list.id))));
};
